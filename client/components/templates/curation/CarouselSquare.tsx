...
import SquareBanner from '@/components/layouts/curation/SquareBanner';
import { TypeBanner } from '@/types/banner';
import { TypeBannerResponse, TypeCurationMeta } from '@/types/operation';

interface TypeCarouselSquare {
  config: TypeBannerResponse;
}

const CarouselSquare = ({ config }: TypeCarouselSquare) => {
  ...
  return (
    <section className="carousel-card carousel-square">
